  ...
  return (
    <>
        ...
        <div className="discover-header-content-container">
          <div className="discover-header-content">
            ...
            <div className='header-title-container'>
              <h1 className='header-title'>Tripadvisor</h1>
            </div>
            <div className='header-result-container'>
              <p className="header-result-label">Results</p>
              <p className="header-result">50</p>
              <mark className="header-result-new-container">
                <div className='header-result-new'>
                  <div className='header-result-new-circle' />
                  <span>2 new</span>
                </div>
              </mark>
            </div>
            ...
            <div className='header-filter-container'>
              <div className='header-filter'>
                <button className='header-filter-btn'>
                  <span>  DE Market</span>
                  <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M16.9497 9.0474C16.5592 8.65688 15.9261 8.65688 15.5355 9.0474L12 12.5829L8.46447 9.0474C8.07394 8.65688 7.44078 8.65688 7.05025 9.0474C6.65973 9.43793 6.65973 10.0711 7.05025 10.4616L11.2929 14.7043C11.6834 15.0948 12.3166 15.0948 12.7071 14.7043L16.9497 10.4616C17.3403 10.0711 17.3403 9.43793 16.9497 9.0474Z"></path></svg>
                </button>
              </div>
              <div className='header-filter'>
                <button className='header-filter-btn'>
      ...
      <div className='company-container'>
        <p className='total-company-count'>50 companies</p>
        <div className='new-companies-container'>
          <button className='new-companies-btn'>
            <div className='new-companies-content'>
              <div className='header-result-new-circle' />
              2 new companies last 7d
            </div>
          </button>
        </div>
        <div className='view-style-container'>
          <button className='table-view view-button'>
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M20 4H4V5H20V4ZM20 7H4V8H20V7ZM4 10H20V11H4V10ZM20 13H4V14H20V13ZM4 16H20V17H4V16ZM20 19H4V20H20V19Z"></path></svg>
          </button>
          <button className='title-view view-button'>
            <svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path fillRule="evenodd" clipRule="evenodd" d="M11 4H4V11H11V4ZM11 13H4V20H11V13ZM13 4H20V11H13V4ZM20 13H13V20H20V13Z"></path></svg>
          </button>
        </div>
      </div>
              ...
              <table className='stocks-table'>
                <thead className='stocks-table-header'>
                  <tr>
                    ...
                    <th className='table-header-company'>Company</th>
                    <th>Last Price</th>
                    <th>7D Return</th>
                    <th>1Y Return</th>
                    <th>
